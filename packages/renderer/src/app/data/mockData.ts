...
export const standaloneSessions: Session[] = [
  ...
  },
  {
    ...
    linkedPRs: [{ id: "pr_utils_1421", number: 1421, title: "Rename getCwd to getCurrentWorkingDirectory", repo: "acme/utils", branch: "agent/rename-getcwd", status: "open", mergeable: "clean", reviewVerdict: "approved", author: "multiplex-agent", additions: 47, deletions: 23, updatedAt: "1h ago", checks: { passed: 5, failed: 0, pending: 0 }, checkRuns: [{ id: "ck_rename_1", name: "ci", status: "success" }] }],
  ...
  },
  {
    ...
    linkedPRs: [
      { id: "pr_shared_88", number: 88, title: "Extract retry-with-jitter helper", repo: "acme/shared-utils", branch: "agent/retry-helper", status: "open", reviewVerdict: "pending", author: "multiplex-agent", additions: 34, deletions: 0, updatedAt: "2d ago", checks: { passed: 3, failed: 0, pending: 0 } },
      { id: "pr_ingest_491", number: 491, title: "Use retry helper in ingest", repo: "acme/ingest", branch: "agent/use-retry-helper", status: "open", reviewVerdict: "pending", author: "multiplex-agent", additions: 28, deletions: 15, updatedAt: "2d ago", checks: { passed: 4, failed: 0, pending: 0 } },
      { id: "pr_ledger_102", number: 102, title: "Use retry helper in ledger", repo: "acme/ledger", branch: "agent/use-retry-helper", status: "open", reviewVerdict: "pending", author: "multiplex-agent", additions: 18, deletions: 9, updatedAt: "3d ago", checks: { passed: 2, failed: 0, pending: 0 } },
    ],
    ...
    sessions: [
      {
        ...
        linkedPRs: [{ id: "pr_ingest_485", number: 485, title: "Investigate p99 spike under replay load", repo: "acme/ingest", branch: "agent/replay-investigate", status: "open", reviewVerdict: "pending", author: "multiplex-agent", additions: 120, deletions: 45, updatedAt: "12m ago", checks: { passed: 2, failed: 0, pending: 3 } }],
        startedAt: "12m ago",
      ...
      },
      {
        ...
        linkedPRs: [{ id: "pr_ingest_487", number: 487, title: "Draft metrics exporter for dedupe hit rate", repo: "acme/ingest", branch: "agent/metrics-export", status: "review", reviewVerdict: "pending", author: "multiplex-agent", additions: 56, deletions: 2, updatedAt: "yesterday", checks: { passed: 4, failed: 0, pending: 0 } }],
        startedAt: "yesterday",
        createdAtMs: NOW - day,
      ...
      },
      {
        ...
        linkedPRs: [{ id: "pr_ingest_482", number: 482, title: "Fix dedupe map memory ceiling", repo: "acme/ingest", branch: "agent/dedupe-memory", status: "open", reviewVerdict: "changes_requested", author: "multiplex-agent", additions: 78, deletions: 34, updatedAt: "yesterday", checks: { passed: 3, failed: 0, pending: 0 }, comments: [{ id: "c1", author: "maya", kind: "review", verdict: "changes_requested", body: "Eviction loop has a race condition — needs lock.", ts: "2h ago" }] }],
        startedAt: "yesterday",
      ...
      },
      {
        ...
        linkedPRs: [{ id: "pr_ingest_488", number: 488, title: "Bump tracing sample rate to 100% on staging", repo: "acme/ingest", branch: "agent/tracing-sample", status: "open", mergeable: "clean", reviewVerdict: "approved", author: "multiplex-agent", additions: 4, deletions: 2, updatedAt: "3h ago", checks: { passed: 5, failed: 0, pending: 0 }, checkRuns: [{ id: "ck_trace_1", name: "ci", status: "success" }] }],
        startedAt: "4h ago",
    ...
    sessions: [
      {
        ...
        linkedPRs: [{ id: "pr_ledger_96", number: 96, title: "Build parity test suite for tax calc", repo: "acme/ledger", branch: "agent/tax-parity", status: "open", reviewVerdict: "pending", author: "multiplex-agent", additions: 340, deletions: 12, updatedAt: "50m ago", checks: { passed: 1, failed: 2, pending: 0 }, checkRuns: [{ id: "ck_ledger_1", name: "build", status: "success" }, { id: "ck_ledger_2", name: "unit-tests", status: "failure" }] }],
        startedAt: "1h ago",
        createdAtMs: NOW - hr,
